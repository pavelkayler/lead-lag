...
export function PresetsPage() {
  ...
  return <Row className="g-3">
    ...
    <Col md={5}><Card body><h6>{draft.name ? "Редактирование" : "Создание"}</h6>
      ...
      <h6 className="mt-3">Автонастройка (Auto-Tune)</h6>
      ...
      <Row className="g-2 mb-2">
        <Col md={6}><Form.Label>minCorr floor/ceil</Form.Label><div className="d-flex gap-1"><Form.Control type="number" step="0.01" value={draft.autoTune?.bounds?.minCorr?.floor ?? 0.05} onChange={(e) => setDraft((d) => ({ ...d, autoTune: { ...(d.autoTune || {}), bounds: { ...(d.autoTune?.bounds || {}), minCorr: { ...(d.autoTune?.bounds?.minCorr || {}), floor: Number(e.target.value) } } } }))} /><Form.Control type="number" step="0.01" value={draft.autoTune?.bounds?.minCorr?.ceil ?? 0.4} onChange={(e) => setDraft((d) => ({ ...d, autoTune: { ...(d.autoTune || {}), bounds: { ...(d.autoTune?.bounds || {}), minCorr: { ...(d.autoTune?.bounds?.minCorr || {}), ceil: Number(e.target.value) } } } }))} /></div></Col>
        <Col md={6}><Form.Label>impulseZ floor/ceil</Form.Label><div className="d-flex gap-1"><Form.Control type="number" step="0.1" value={draft.autoTune?.bounds?.impulseZ?.floor ?? 1.2} onChange={(e) => setDraft((d) => ({ ...d, autoTune: { ...(d.autoTune || {}), bounds: { ...(d.autoTune?.bounds || {}), impulseZ: { ...(d.autoTune?.bounds?.impulseZ || {}), floor: Number(e.target.value) } } } }))} /><Form.Control type="number" step="0.1" value={draft.autoTune?.bounds?.impulseZ?.ceil ?? 4} onChange={(e) => setDraft((d) => ({ ...d, autoTune: { ...(d.autoTune || {}), bounds: { ...(d.autoTune?.bounds || {}), impulseZ: { ...(d.autoTune?.bounds?.impulseZ || {}), ceil: Number(e.target.value) } } } }))} /></div></Col>
        <Col md={6}><Form.Label>confirmZ floor/ceil</Form.Label><div className="d-flex gap-1"><Form.Control type="number" step="0.01" value={draft.autoTune?.bounds?.confirmZ?.floor ?? 0.05} onChange={(e) => setDraft((d) => ({ ...d, autoTune: { ...(d.autoTune || {}), bounds: { ...(d.autoTune?.bounds || {}), confirmZ: { ...(d.autoTune?.bounds?.confirmZ || {}), floor: Number(e.target.value) } } } }))} /><Form.Control type="number" step="0.01" value={draft.autoTune?.bounds?.confirmZ?.ceil ?? 1} onChange={(e) => setDraft((d) => ({ ...d, autoTune: { ...(d.autoTune || {}), bounds: { ...(d.autoTune?.bounds || {}), confirmZ: { ...(d.autoTune?.bounds?.confirmZ || {}), ceil: Number(e.target.value) } } } }))} /></div></Col>
        <Col md={6}><Form.Label>edgeMult floor/ceil</Form.Label><div className="d-flex gap-1"><Form.Control type="number" step="0.1" value={draft.autoTune?.bounds?.edgeMult?.floor ?? 1.5} onChange={(e) => setDraft((d) => ({ ...d, autoTune: { ...(d.autoTune || {}), bounds: { ...(d.autoTune?.bounds || {}), edgeMult: { ...(d.autoTune?.bounds?.edgeMult || {}), floor: Number(e.target.value) } } } }))} /><Form.Control type="number" step="0.1" value={draft.autoTune?.bounds?.edgeMult?.ceil ?? 8} onChange={(e) => setDraft((d) => ({ ...d, autoTune: { ...(d.autoTune || {}), bounds: { ...(d.autoTune?.bounds || {}), edgeMult: { ...(d.autoTune?.bounds?.edgeMult || {}), ceil: Number(e.target.value) } } } }))} /></div></Col>
      </Row>
